...
/** Utility functions used by the Loonie Qt UI.
 */
namespace GUIUtil
{
...
// Render Loonie addresses in monospace font
...
// Parse "loonie:" URI into recipient object, return true on successful parsing
