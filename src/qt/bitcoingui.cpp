...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and loonie: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zLNI"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Loonie"), this);
    aboutAction->setStatusTip(tr("Show information about Loonie"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Loonie"));
    ...
    openAction->setStatusTip(tr("Open a Loonie: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Loonie help message to get a list with possible Loonie command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Loonie client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumBlocks(int count)
{
    ...
    if (masternodeSync.IsBlockchainSynced()) {
        ...
        if (masternodeSync.IsSynced()) {
            ...
            progressBar->setMaximum(3 * MASTERNODE_SYNC_THRESHOLD);
...
{
    QString strTitle = tr("Loonie"); // default title
