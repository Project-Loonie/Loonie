...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Loonie loonie-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  loonie-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded loonie transaction") + "\n" +
                               "  loonie-tx [options] -create [commands]   " + _("Create hex-encoded loonie transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded loonie transaction
