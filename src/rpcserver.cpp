...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Loonie features */
        {"loonie", "masternode", &masternode, true, true, false},
        {"loonie", "listmasternodes", &listmasternodes, true, true, false},
        {"loonie", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"loonie", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"loonie", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"loonie", "getmasternodecount", &getmasternodecount, true, true, false},
        {"loonie", "masternodeconnect", &masternodeconnect, true, true, false},
        {"loonie", "masternodecurrent", &masternodecurrent, true, true, false},
        {"loonie", "masternodedebug", &masternodedebug, true, true, false},
        {"loonie", "startmasternode", &startmasternode, true, true, false},
        {"loonie", "createmasternodekey", &createmasternodekey, true, true, false},
        {"loonie", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"loonie", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"loonie", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"loonie", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"loonie", "getmasternodescores", &getmasternodescores, true, true, false},
        {"loonie", "mnbudget", &mnbudget, true, true, false},
        {"loonie", "preparebudget", &preparebudget, true, true, false},
        {"loonie", "submitbudget", &submitbudget, true, true, false},
        {"loonie", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"loonie", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"loonie", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"loonie", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"loonie", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"loonie", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"loonie", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"loonie", "checkbudgets", &checkbudgets, true, true, false},
        {"loonie", "mnsync", &mnsync, true, true, false},
        {"loonie", "spork", &spork, true, true, false},
        {"loonie", "getpoolinfo", &getpoolinfo, true, true, false},
        {"loonie", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
...
{
    return "> loonie-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:58924/\n";
}
