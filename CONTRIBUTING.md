Contributing to Loonie
============================

The Loonie project operates an open contributor model where anyone is
...
The following applies to code changes to the Loonie project, and is not to be
confused with overall Loonie Network Protocol consensus changes.

Whether a pull request is merged into Loonie rests with the project merge
...
Patches that change Loonie consensus rules are considerably more involved than
...
The project leader is the release manager for each Loonie release.
