...
- Detached signatures will then be committed to the [loonie-detached-sigs](https://github.com/LoonieCoin/loonie-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
